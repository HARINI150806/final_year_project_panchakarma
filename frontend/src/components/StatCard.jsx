export default function StatCard({ title, value, subtitle }) {
  return (
    <div className="panel-frost group hover-lift relative overflow-hidden rounded-[2rem] p-5">
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="h-12 w-12 rounded-full bg-[radial-gradient(circle,rgba(107,154,103,0.18),rgba(107,154,103,0.03))] transition duration-300 group-hover:scale-110" />
      </div>
