...
public class User {
    ...
    @Column(name = "is_senior_therapist", nullable = false, columnDefinition = "boolean default false")
    private boolean isSeniorTherapist = false;

    @Column(name = "in_app_notif_enabled", nullable = false, columnDefinition = "boolean default true")
    private boolean inAppNotifEnabled = true;

    @Column(name = "email_notif_enabled", nullable = false, columnDefinition = "boolean default true")
    ...
    public boolean isSeniorTherapist() {
        return isSeniorTherapist;
    }

    public void setSeniorTherapist(boolean isSeniorTherapist) {
        this.isSeniorTherapist = isSeniorTherapist;
    }

    public boolean isInAppNotifEnabled() {
        return inAppNotifEnabled;
    }

    public void setInAppNotifEnabled(boolean inAppNotifEnabled) {
        this.inAppNotifEnabled = inAppNotifEnabled;
    }
